...
- src/dynamsoft.imagecore-1.8.x.wasm & dynamsoft.imageio-1.8.x.wasm & dynamsoft.imageio.js & dynamsoft.imageio_wasm-1.8.x.js & dynamsoft.imageProc-1.8.x.wasm & dynamsoft.imageProc-sn-1.8.x.wasm & dynamsoft.crypto-1.8.x.wasm & dynamsoft.lts.js
These files contain functionalities for image input & output + decode & encode.

- src/dynamsoft.pdfReader-1.8.x.wasm & dynamsoft.pdfWriter-1.8.x.wasm & dynamsoft.pdfReader_wasm-1.8.x.js
